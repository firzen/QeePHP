<?php
// $Id: group.php 2447 2009-04-28 05:40:53Z jerry $
 ...
 * @version $Id: group.php 2447 2009-04-28 05:40:53Z jerry $
 * @package form
 */
...
class QForm_Group extends QForm_Element implements ArrayAccess
{
    ...
    function add($type, $id, array $attrs = null)
    {
        ...
        {
            throw new QForm_Exception(Q::__('Invalid type "%s".', $type));
        }
    ...
    function addValidations($source)
    {
        ...
        {
            throw new QForm_Exception(Q::__('Typemismatch, expected array, actual is "%s".', gettype($source)));
        }
    ...
    protected function _import($data, $parent_data = null)
    {
        if (!is_array($data) && !($data instanceof ArrayAccess))
        {
            ...
            throw new QForm_Exception(Q::__('$data 参数应该是一个数组或一个实现了 ArrayAccess 接口的对象.'));
        }
