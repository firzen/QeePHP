<?php
// $Id: validator.php 2663 2009-09-23 03:32:55Z jerry $
 ...
 * @version $Id: validator.php 2663 2009-09-23 03:32:55Z jerry $
 * @package helper
 */
...
abstract class QValidator
{
    ...
    static function validateByArgs($validation, array $args)
    {
        ...
        {
            throw new Q_NotImplementedException(Q::__($validation));
        }
        return $result;
    }
