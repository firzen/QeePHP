<?php
// $Id: hasmany.php 2612 2009-07-06 21:47:48Z dualface $
 ...
 * @version $Id: hasmany.php 2612 2009-07-06 21:47:48Z dualface $
 * @package orm
 */
    ...
    function onSourceDestroy(QDB_ActiveRecord_Abstract $source)
    {
        ...
        elseif ($this->on_delete == 'reject')
        {
            ...
            if (intval($row['row_count']) > 0)
            {
                ...
                throw new QDB_ActiveRecord_Association_RejectException(Q::__(
