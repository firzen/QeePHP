...
class QColl implements Iterator, ArrayAccess, Countable
{
    ...
    function offsetGet($offset)
    {
        ...
        // LC_MSG: 无效的键名 "%s".
        throw new QException(Q::__('无效的键名 "%s".', $offset));
    }
    ...
    function first()
    {
        ...
        // LC_MSG: "%s" 集合中没有任何对象.
        throw new QException(Q::__('"%s" 集合中没有任何对象.', $this->_type));
    }
    ...
    function append($data)
    {
        ...
        else
        {
            ...
            throw new QException(Q::__('"%s()" 的参数 "%s" 必须是 "%s"，但实际提供的是 "%s".',
    ...
    protected function _checkType($object)
    {
        ...
        throw new QException(Q::__('集合只能容纳 "%s" 类型的对象，而不是 "%s" 类型的值.', $this->_type, $type));
    }
